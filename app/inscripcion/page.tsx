...
export default function RegistrationPage() {
  return (
    <main>
      ...
      <section className="section form-section"><div><p className="section-index">SOLICITUD DE INFORMACIÓN</p><h2>Tu práctica,<br />tu punto de partida.</h2><p>Completa los datos y prepararemos un correo dirigido al equipo académico. No se realizará ningún cobro desde este sitio.</p><div className="contact-note"><span>Contacto directo</span><a href="mailto:neurosonologialatam@gmail.com">neurosonologialatam@gmail.com</a></div></div><RegistrationForm /></section>
