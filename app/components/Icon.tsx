...
// Sistema de iconos SVG con glifos de lucide (MIT, inline — sin dependencia de runtime).
// Uso: <Icon name="arrowUpRight" /> · animación en CTAs vía clase .icon-cta (CSS, respeta reduced-motion).
